/**
 * SQLite database access layer for the FKTK financial regulation MCP server.
 *
 * Schema mirrors the FKTK (Finansu un kapitala tirgus komisija) regulatory structure:
 *   - sourcebooks        — top-level FKTK regulatory sourcebook collections
 *   - provisions         — individual FKTK noteikumi, ieteikumi, and vadlinijas
 *   - enforcement_actions — FKTK enforcement decisions and sanctions
 *
