...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across FKTK regulatory provisions. Returns matching noteikumi, ieteikumi, and vadlinijas.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., FKTK_Noteikumi). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific FKTK regulatory provision by sourcebook and reference.",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., FKTK_Noteikumi)" },
        reference: { type: "string", description: "Provision reference (e.g., FKTK noteikumi 100)" },
      },
  ...
  },
  {
    ...
    description: "List all FKTK regulatory sourcebooks with names and descriptions.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "lv_fin_search_enforcement",
    description:
      "Search FKTK enforcement actions — sodi (fines), lemumi (decisions), and sanctions.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Check whether a specific FKTK regulatory provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "Provision reference (e.g., FKTK noteikumi 100)" },
